                ...
                >
                    ...
                    {[...experts, ...experts, ...experts].map((expert, index) => (
                        <div key={index} className="w-[350px] mx-4 flex-shrink-0">
                            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col items-start text-left group">
