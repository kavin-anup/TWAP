      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <button className="bg-[#f25a1a] hover:bg-[#d14815] text-white px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer whitespace-nowrap">
              Browse Apps
            </button>
            <button className="bg-[#1F2853] hover:bg-[#162040] text-white px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer whitespace-nowrap">
              Submit Your App
            </button>
            <button className="bg-white/20 backdrop-blur-md border border-white/30 text-white hover:bg-white/30 hover:border-white/50 px-6 py-3 rounded-lg font-medium transition-all cursor-pointer whitespace-nowrap">
