...
export default function MostLovedApps() {
  ...
  return (
    <section className="py-16" style={{ 
      ...
      backgroundImage: `url('/assets/loved-apps-bg.webp')`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          <div 
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(31, 40, 83, 0.3) 0%, rgba(22, 32, 64, 0.4) 100%)',
            ...
            <div className="relative z-10">
              <div className="space-y-6">
                {displayedApps.map((app, index) => (
                  <div 
                    key={app.rank} 
                    className="flex items-center gap-6 p-6 rounded-xl transition-all duration-300 cursor-pointer hover:scale-[1.02] relative group/item overflow-hidden"
                    style={{
                  ...
                  >
                    ...
                    {/* Rank */}
                    <div className="relative z-10 flex items-center justify-center w-16 h-16 rounded-full font-bold text-xl"
                         style={{ 
                           background: index < 3 
                             ? 'linear-gradient(135deg, rgba(255, 206, 224, 0.9) 0%, rgba(255, 179, 214, 0.9) 100%)' 
                             : 'rgba(255, 255, 255, 0.15)',
                           backdropFilter: 'blur(10px)',
                           border: index < 3 ? '2px solid rgba(255, 206, 224, 0.5)' : '1px solid rgba(255, 255, 255, 0.2)',
                      ...
                      #{app.rank}
                      {index < 3 && (
                        <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center text-xs backdrop-blur-sm"
                             style={{ 
              ...
              <div className="mt-8 text-center">
                <button 
                  ...
                  style={{ 
                    background: 'linear-gradient(135deg, rgba(255, 206, 224, 0.95) 0%, rgba(255, 179, 214, 0.95) 100%)',
                    backdropFilter: 'blur(10px)',
                    color: '#1F2853',
                    fontFamily: 'Poppins, sans-serif',
                    border: '1px solid rgba(255, 255, 255, 0.3)',
                    boxShadow: '0 4px 20px rgba(255, 206, 224, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.3)'
                  }}
                >
                  <span className="relative z-10">{showAll ? 'Show Less' : 'View All Loved Apps'}</span>
