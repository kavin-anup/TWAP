        ...
        <div className="bg-gray-800/40 backdrop-blur-md rounded-full border border-white/10 px-6 py-3 shadow-lg">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6 lg:space-x-8">
              <a href="/" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Home
              </a>
              <a href="/directory" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Directory
              </a>
              <a href="/reviews" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Reviews
              </a>
              <a href="/news" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                News
              </a>
              <a href="/insights" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Insights
              </a>
              <a href="/services" className="text-white hover:text-[#f25a1a] font-medium transition-colors text-sm lg:text-base" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Services
              </a>
            </nav>
